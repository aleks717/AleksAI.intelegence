...
export const FAQ_DATA: FAQItem[] = [
  ...
  },
  {
    ...
    answer: {
      de: "Nutze AleksAI Intelegence (Gemini Intelligence) für kreative Texte und multimodale Aufgaben, AleksAI Pro (GPT-4o) für schnelle, logische Antworten, AleksAI neo (Llama) für prägnante, direkte Chats, AleksAI Max (Meta Llama) für extrem anspruchsvolle tiefgehende Analysen und AleksAI Business (Claude) für exzellenten Code und lange Dokumente.",
      en: "Use AleksAI Intelegence (Gemini Intelligence) for creative writing and multimodal work, AleksAI Pro (GPT-4o) for fast, logical answers, AleksAI neo (Llama) for concise responses, AleksAI Max (Meta Llama) for incredibly deep logical reasoning, and AleksAI Business (Claude) for peak performance coding and brilliant language understanding.",
      es: "Usa AleksAI Intelegence (Gemini Intelligence) para redacción creativa, AleksAI Pro (GPT-4o) para respuestas rápidas y lógicas, AleksAI neo (Llama) para chats directos y breves, AleksAI Max (Meta Llama) para razonamiento lógico profundo und AleksAI Business (Claude) para desarrollo de código excelente.",
      fr: "Utilisez AleksAI Intelegence (Gemini Intelligence) pour la rédaction créative, AleksAI Pro (GPT-4o) pour des réponses logiques et ultra-rapides, AleksAI neo (Llama) pour des discussions directes, AleksAI Max (Meta Llama) pour des analyses de logique complexes, et AleksAI Business (Claude) pour un codage de haut niveau.",
      it: "Usa AleksAI Intelegence (Gemini Intelligence) per testi creativi, AleksAI Pro (GPT-4o) per risposte logiche e veloci, AleksAI neo (Llama) per conversazioni coincise, AleksAI Max (Meta Llama) per riflessioni logiche profonde, e AleksAI Business (Claude) per codice eccellente.",
      tr: "Yaratıcı metinler ve görseller için AleksAI Intelegence (Gemini Intelligence), hızlı ve mantıklı yanıtlar için AleksAI Pro (GPT-4o), doğrudan sohbetler için AleksAI neo (Llama), derinlemesine analiz için AleksAI Max (Meta Llama) ve yazılım geliştirme & kod yazma için AleksAI Business (Claude) modelini kullanın.",
      sr: "Koristite AleksAI Intelegence (Gemini Intelligence) za kreativno pisanje, AleksAI Pro (GPT-4o) za brze i logične odgovore, AleksAI neo (Llama) za koncizne razgovore, AleksAI Max (Meta Llama) za duboko logičko razmišljanje, a AleksAI Business (Claude) za vrhunsko programiranje i dugačke analize.",
    }
  },
  {
    id: "faq-4",
  ...
  },
  {
    ...
    answer: {
      ...
      tr: "Evet, AleksAI mükemmel bir programlama ortağıdır! HTML, CSS, JavaScript, Python, C++, SQL veya Java fark etmeksizin kod yazar, mantıksal hataları açıklar und algoritmaları saniyeler içinde optimize eder.",
...
export const INITIAL_REVIEWS: Review[] = [
  {
    ...
    name: "Hasan M.",
    rating: 5,
    text: "Die Performance hier schlägt alles! Dass ich AleksAI Intelegence (Gemini Intelligence) und AleksAI Business für vollkommen kostenfrei und ohne nerviges Abo nutzen kann, ist eine absolute Revolution. Beste Seite!",
    model: "AleksAI Intelegence",
    date: "12.06.2026"
  },
  {
    id: "rev-2",
  ...
  },
  {
    ...
    bullets: {
      de: [
        ...
        "Integration von Meta Llama 3.3 (AleksAI Intelegence) für anspruchsvolle Text- und logische Analysen.",
      ...
      en: [
        ...
        "Integration of Meta Llama 3.3 (AleksAI Intelegence) for rich text and reasoning analyses.",
      ...
      es: [
        ...
        "Introducción de Meta Llama 3.3 (AleksAI Intelegence) para resolver tareas complejas y análisis de texto.",
      ...
      fr: [
        ...
        "Ajout de Meta Llama 3.3 (AleksAI Intelegence) pour les analyses complexes et la rédaction.",
      ...
      it: [
        ...
        "Introduzione di Meta Llama 3.3 (AleksAI Intelegence) per sessioni di scrittura e analisi complessa.",
      ...
      tr: [
        ...
        "Zengin metin analizi ve yazım becerileri için Meta Llama 3.3 (AleksAI Intelegence) eklendi.",
      ...
      sr: [
        ...
        "Dodat model Meta Llama 3.3 (AleksAI Intelegence) za rešavanje složenih tekstualnih i logičkih zadataka.",
